...
export default function MyEventsPage() {
  ...
  const fetchMyEvents = async () => {
    try {
      const response = await fetch('/api/events?session=mine');
    ...
    <div className="min-h-[calc(100vh-10rem)] bg-background">
      <div className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="font-bold mb-8 text-gray-900" style={{fontSize: '32px'}}>
            My Events
          </h1>
          ...
          {loading ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600" style={{fontSize: '17px', lineHeight: '1.5'}}>Loading events...</p>
            </div>
          ) : events.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-600 mb-4" style={{fontSize: '17px', lineHeight: '1.5'}}>
