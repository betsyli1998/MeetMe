        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <button
              ...
              className="flex items-center justify-center gap-2 bg-gray-100 border-2 border-gray-300 px-6 py-4 rounded-md font-semibold hover:bg-gray-200 transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 bg-blue-500 text-white px-6 py-4 rounded-md font-semibold hover:bg-blue-600 transition-colors"
            >
